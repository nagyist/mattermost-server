...
func (l *License) FeaturesToMap() map[string]any {
	return map[string]any{
		"ldap":                        l.HasLDAP(),
		"ldap_groups":                 l != nil && l.Features != nil && *l.Features.LDAPGroups,
		"mfa":                         l != nil && l.Features != nil && *l.Features.MFA,
		"google":                      l != nil && l.Features != nil && *l.Features.GoogleOAuth,
		"office365":                   l != nil && l.Features != nil && *l.Features.Office365OAuth,
		"openid":                      l != nil && l.Features != nil && *l.Features.OpenId,
		"compliance":                  l != nil && l.Features != nil && *l.Features.Compliance,
		"cluster":                     l != nil && l.Features != nil && *l.Features.Cluster,
		"metrics":                     l != nil && l.Features != nil && *l.Features.Metrics,
		"mhpns":                       l != nil && l.Features != nil && *l.Features.MHPNS,
		"saml":                        l != nil && l.Features != nil && *l.Features.SAML,
		"elastic_search":              l != nil && l.Features != nil && *l.Features.Elasticsearch,
		"email_notification_contents": l != nil && l.Features != nil && *l.Features.EmailNotificationContents,
		"data_retention":              l != nil && l.Features != nil && *l.Features.DataRetention,
		"message_export":              l != nil && l.Features != nil && *l.Features.MessageExport,
		"custom_permissions_schemes":  l != nil && l.Features != nil && *l.Features.CustomPermissionsSchemes,
		"guest_accounts":              l != nil && l.Features != nil && *l.Features.GuestAccounts,
		"guest_accounts_permissions":  l != nil && l.Features != nil && *l.Features.GuestAccountsPermissions,
		"id_loaded":                   l != nil && l.Features != nil && *l.Features.IDLoadedPushNotifications,
		"lock_teammate_name_display":  l != nil && l.Features != nil && *l.Features.LockTeammateNameDisplay,
		"enterprise_plugins":          l.HasEnterpriseMarketplacePlugins(),
		"advanced_logging":            l != nil && l.Features != nil && *l.Features.AdvancedLogging,
		"cloud":                       l != nil && l.Features != nil && *l.Features.Cloud,
		"shared_channels":             l != nil && l.Features != nil && *l.Features.SharedChannels,
		"remote_cluster_service":      l != nil && l.Features != nil && *l.Features.RemoteClusterService,
		"future":                      l != nil && l.Features != nil && *l.Features.FutureFeatures,
	}
}
